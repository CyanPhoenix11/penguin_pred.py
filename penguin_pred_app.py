...
def prediction(model,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,sex):
  species = model.predict([[model,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,sex]])
  species = species[0]
  if species == 0:
    return 'Adelie'
  elif species == 1:
...
sex_temp = st.sidebar.selectbox('Sex', ('Male', 'Female'))
island_temp = st.sidebar.selectbox('Island', ('Biscoe','Dream','Torgersen')
if sex_temp=='Male':
  sex=0
else:
  sex=1
if island_temp ='Biscoe':
  island=0
elif island_temp =='Dream':
  island=1
else:
  island=2
